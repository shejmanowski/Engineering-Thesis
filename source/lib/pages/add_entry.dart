...
class _AddEntryPageState extends State<AddEntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Dodaj wpis',style: TextStyle(color: Theme.of(context).colorScheme.inversePrimary),
          ),
          centerTitle: true,
          elevation: 0,
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Co pozytywnie wpłynęło na twój humor?'),
                ),
                TextField(
                  maxLines: null, 
                  keyboardType: TextInputType.multiline,
                  ...
                  decoration: InputDecoration(labelText: 'Jakie przeciwnosci cię spotkały?'),
                ),
                TextField(
                  maxLines: null, 
                  keyboardType: TextInputType.multiline,
                  ...
                  decoration: InputDecoration(labelText: 'Za co jesteś wdzięczny?'),
                ),
                SizedBox(height: 20),
                Align(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Wyślij',style: TextStyle(color: Theme.of(context).colorScheme.inversePrimary),),
                  ),
                ),
              ],
            ),
